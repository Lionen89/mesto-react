...
function handleSubmit(e) {
    ...
    return (
<PopupWithForm name='edit' title='Редактировать профиль' isOpen={props.isOpen} 
  ...
  <label className='popup__form-field'>
          <input type="text" className="popup__input popup__text" id="name-input" name="name" required minLength="2"
            maxLength="40" placeholder='Имя' value={name} onChange={handleNameChange} />
          <span className="name-input-error popup__error"></span>
        </label>
        <label className='popup__form-field'>
          <input type="text" className="popup__input popup__text" id="description-input" name="description" required
            minLength="2" maxLength="200" placeholder='О себе' value={description} 
